...
class Os extends CI_Controller {
    ...
    public function gerenciar() {
        ...
        if ($pesquisa != null or $pesquisaPatrimonio != null or $status != null or $de != null or $ate != null) {
        ...
        $results = $this->os_model->getOs('os', 'idOs,dataInicial,dataPrevisao,dataFinal,garantia,refGarantia,descricaoProduto,defeito,status,observacoes,laudoTecnico,valorTotal,patrimonio,modelo,mac,clientes_id', $where_array, $config['per_page'], $this->uri->segment(3));
    ...
    public function faturar() {
        ...
        if ($this->form_validation->run('receita') == false) {
            ...
            $data2 = array(
                'tecnico' => set_value('tecnicoFatura'),
                'clienteOS' => set_value('cliente'),
                'os_id' => $this->input->post('os_id'),
                'tipo' => $this->input->post('tipoComissao'),
                'valorComissao' => $this->input->post('comissao'),
            ...
            if ($this->os_model->add('lancamentos', $data) == true) {
                ...
                if ($this->input->post('comissao') != 0) {
                    $this->os_model->add('comissao', $data2);
                }
