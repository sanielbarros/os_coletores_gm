    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = array(
                ...
                'aPatrimonio' => $this->input->post('aPatrimonio'),
                'ePatrimonio' => $this->input->post('ePatrimonio'),
                'dPatrimonio' => $this->input->post('dPatrimonio'),
                'vPatrimonio' => $this->input->post('vPatrimonio'),
                ...
                'rPatrimonio' => $this->input->post('rPatrimonio'),
