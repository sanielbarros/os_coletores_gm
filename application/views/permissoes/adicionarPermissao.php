                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="vPatrimonio" class="marcar" type="checkbox" checked="checked" value="1" />
                                        ...
                                        <td>
                                            <label>
                                                <input name="aPatrimonio" class="marcar" type="checkbox" value="1" />
                                        ...
                                        <td>
                                            <label>
                                                <input name="ePatrimonio" class="marcar" type="checkbox" value="1" />
                                        ...
                                        <td>
                                            <label>
                                                <input name="dpatrimonio" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="rPatrimonio" class="marcar" type="checkbox" value="1" />
