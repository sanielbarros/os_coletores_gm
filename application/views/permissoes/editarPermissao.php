                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['vPatrimonio'])) {
                                                if ($permissoes['vPatrimonio'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="vPatrimonio" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Patrimônio</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['aPatrimonio'])) {
                                                if ($permissoes['aPatrimonio'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="aPatrimonio" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Patrimônio</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['ePatrimonio'])) {
                                                if ($permissoes['ePatrimonio'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="ePatrimonio" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Patrimônio</span>
                                        </label>
                                    </td>

                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['dPatrimonio'])) {
                                                if ($permissoes['dPatrimonio'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="dPatrimonio" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Excluir Patrimônio</span>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if (isset($permissoes['rPatrimonio'])) {
                                                if ($permissoes['rPatrimonio'] == '1') {
                                                    echo 'checked';
                                                }
}?> name="rPatrimonio" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Relatório Patrimônio</span>
                                        </label>
                                    </td>
