        ...
        <div class="widget-box">
            <div class="widget-title">
                ...
                <div class="buttons">
                    ...
                    <a href="<?php echo site_url() ?>/mine/finalizar_os/?id=<?php echo $result->idOs ?>&status=<?php echo $result->status ?>" class="btn btn-mini btn-success"><i class="fas fa-check"></i> Finalizar OS</a>
                    <a href="<?php echo site_url() ?>/mine/finalizar_os/?id=<?php echo $result->idOs ?>&status=<?php echo $result->status ?>" class="btn btn-mini btn-danger"><i class="fas fa-trash-alt"></i> Cancelar OS</a>
                    <a target="_blank" title="Imprimir" class="btn btn-mini btn-inverse" href="<?php echo site_url() ?>/min/imprimirOs/<?php echo $result->idOs; ?>"><i class="fas fa-print"></i> Imprimir</a>
                </div>
            </div>
