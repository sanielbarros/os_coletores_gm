            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="departamento" type="text" name="departamento" value="<?php echo $result->departamento; ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="descricaoFornecedor" type="text" name="descricaoFornecedor" value="<?php echo $result->descricaoFornecedor; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="referenciaFornecedor" type="text" name="referenciaFornecedor" value="<?php echo $result->referenciaFornecedor; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoFornecedor" class="money" type="text" name="precoFornecedor" value="<?php echo $result->precoFornecedor; ?>" />
                        </div>
                    </div>
