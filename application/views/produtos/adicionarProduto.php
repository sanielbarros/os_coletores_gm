            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal">
                    <div class="control-group">
                        <label for="codDeBarra" class="control-label">Código produto<span class="">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="departamento" class="control-label">Departamento<span class="required">*</span></label>
                        <div class="controls">
                ...
                -->
                    ...
                    <div class="control-group">
                        <label for="descricaoFornecedor" class="control-label">Descrição Fornecedor<span class="required">*</span></label>
                        <div class="controls">
                            <input id="descricaoFornecedor" type="text" name="descricaoFornecedor" value="<?php echo set_value('descricaoFornecedor'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="referenciaFornecedor" class="control-label">Referência Fornecedor<span class="required">*</span></label>
                        <div class="controls">
                            <input id="referenciaFornecedor" type="text" name="referenciaFornecedor" value="<?php echo set_value('referenciaFornecedor'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="precoFornecedor" class="control-label">Preço Fornecedor<span class="required">*</span></label>
                        <div class="controls">
                            <input id="precoFornecedor" class="money" type="text" name="precoFornecedor" value="<?php echo set_value('precoFornecedor'); ?>" />
                        </div>
                    </div>
                    
                    <div class="control-group">
                        <label for="unidade" class="control-label">Embalagem<span class="required">*</span></label>
                        <div class="controls">
