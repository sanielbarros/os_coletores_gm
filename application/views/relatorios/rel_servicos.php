    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a target="_blank" href="<?php echo base_url() ?>index.php/relatorios/servicosRapid?metodo=pdf"><i class="fas fa-wrench"></i> <small>Todos os Serviços (PDF)</small></a></li>
                </ul>
            </div>
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a target="_blank" href="<?php echo base_url() ?>index.php/relatorios/servicosRapid?metodo=excel"><i class="fas fa-wrench"></i> <small>Todos os Serviços (EXCEL)</small></a></li>
                </ul>
            </div>
        </div>
    </div>
