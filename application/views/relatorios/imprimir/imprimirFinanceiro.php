                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th style="font-size: 1.2em; padding: 5px; text-align: center">Cliente/Fornecedor</th>
                                        <th style="font-size: 1.2em; padding: 5px; text-align: center">Tipo</th>
                                        <th style="font-size: 1.2em; padding: 5px; text-align: center">Vencimento</th>
                                        <th style="font-size: 1.2em; padding: 5px; text-align: center">Pagamento</th>
                                        <th style="font-size: 1.2em; padding: 5px; text-align: center">OS</th>
                                        <th style="font-size: 1.2em; padding: 5px; text-align: center">Valor</th>
                                        <th style="font-size: 1.2em; padding: 5px; text-align: center">Situação</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
