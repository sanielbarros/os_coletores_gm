...
<?php if ($result->dataInicial != null) { ?>
    ...
    <?php echo date('d/m/Y', strtotime($result->dataInicial)); ?>
                                        ...
                                        <td>
                                            <b>DATA FINAL: </b>
    <?php echo $result->dataFinal ? date('d/m/Y', strtotime($result->dataFinal)) : 'Pendente'; ?>
                                        </td>
    ...
    <?php echo $result->garantia; ?>
                                             ...
                                             <!--<td>
                                                    <b>TERMO GARANTIA: </b>
    <?php //echo $result->refGarantia != null ? $result->refGarantia : "Não possui";   ?>
                                                </td>-->
                                    </tr>
                                    <tr>
...
<?php } ?>
                                ...
                                <!--Removido pois não está sendo usado no cadastro de OS-->
                            ...
                            <table class="table table-bordered table-condensed" id="tblProdutos">
                                ...
                                <tbody>
                                    ...
                                    foreach ($produtos as $p) {
                                        ...
                                        echo '<tr>';
                                        echo '<td>' . $p->codproduto . ' - ' . $p->descricao . '</td>';
                            ...
                            <tr>
                                ...
                                <td colspan="5"> 
                                    ...
                                    <?php foreach ($anexos as $a) { ?>
                                        <a href="#modal-anexo"><img style="width: 300px; margin-left: 50px" src = '<?php echo $a->url ?>/<?php echo $a->anexo ?>'/></a>
