...
<head>
  <title>CENTRAL DE OS MATEUS</title>
  <meta charset="UTF-8" />
  ...
  <script type="text/javascript">
    ...
    shortcut.add("F6", function() { 
      location.href = '<?php echo base_url(); ?>index.php/patrimonios';
    });
...
<body onLoad="initTimer();">
  ...
  <div id="sidebar"> <a href="#" class="visible-phone"><i class="fas fa-list"></i> Menu</a>
    <ul>
      <li class="<?php if (isset($menuPainel)) {
                    echo 'active';
                  }; ?>"><a href="<?php echo base_url() ?>"><i class="fas fa-home"></i> <span>Dashboard Coletor</span></a></li>
      ...
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vPatrimonio')) { ?>
        <li class="<?php if (isset($menuPatrimonios)) {
                        echo 'active';
                      }; ?>"><a href="<?php echo base_url() ?>index.php/patrimonios"><i class="fas fa-cash-register"></i> <span>Patrimônios</span></a></li>
      <?php
      } ?>
      ...
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vLancamento')) { ?>
        <li class="submenu <?php if (isset($menuFinanceiro)) {
          ...
          <ul>
            ...
            <li><a href="<?php echo base_url() ?>index.php/financeiro/comissao">Comissão Técnico</a></li>
          </ul>
        </li>
      <?php
      } ?>
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rCliente') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rProduto') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rServico') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rOs') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rFinanceiro') || $this->permission->checkPermission($this->session->userdata('permissao'), 'rVenda')) { ?>
        <li class="submenu <?php if (isset($menuRelatorios)) {
          ...
          <ul>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'rPatrimonio')) { ?>
              <li><a href="<?php echo base_url() ?>index.php/relatorios/patrimonios">Patrimônios</a></li>
            <?php
              } ?>
  ...
  <div class="row-fluid">
    <div id="footer" class="span12"> <a href="#">
        <?php echo date('Y'); ?> &copy; Saniel Barros</a></div>
  </div>
  <!--end-Footer-part-->
